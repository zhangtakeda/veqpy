...
namespace
{
    ...
    static_assert(!linalg::detail::uses_runtime_lapack<linalg::Thomas, 3, 8096>);
#else
    ...
    static_assert(linalg::detail::thomas_lapack_min_order == 8096);
    static_assert(!linalg::detail::uses_runtime_lapack<linalg::Thomas, 3, 8095>);
    static_assert(linalg::detail::uses_runtime_lapack<linalg::Thomas, 3, 8096>);
#endif
