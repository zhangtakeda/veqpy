...
namespace veqlib_kernel_api
{
    namespace
    {
        ...
        enum InitialPolicyCode : int
        {
            ...
            InitialPolicyContinuationV1 = 5,
            InitialPolicyContinuationV2 = 6,
            InitialPolicyContinuationV3 = 7,
        };
        ...
        constexpr std::array<double, KernelSource::sample_count> default_scaled_heat = {
        ...
        constexpr std::array<double, KernelSource::sample_count> default_scaled_current = {
