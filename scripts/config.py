...
CASE_REFERENCE_EQUILIBRIUM_JSONS = {
    "solovev": "data/solovev-equilibrium.json",
    "chease": "data/chease-equilibrium.json",
    "efit": "data/efit-equilibrium.json",
}
REFERENCE_EQUILIBRIUM_MANIFEST_PATH = "data/reference_equilibria.json"
...
REDUCED_EQUILIBRIUM_JSON_TEMPLATE = "data/pareto_reduced_{case_key}_{config_label}.json"
REDUCED_EQUILIBRIUM_MANIFEST_PATH = "data/pareto_reduced_equilibria.json"
...
def load_veqpy_components() -> dict[str, object]:
    ...
    try:
        ...
        source_parameterization_for_route_key = None
    ...
    return {
        ...
        "source_parameterization_for_route_key": source_parameterization_for_route_key,
    }
...
def build_pf_case(benchmark, reference: PfReferenceCase, signature: dict[str, int]):
    return benchmark.OperatorCase(
        ...
        coordinate="psin",
        nodes="uniform",
        profile_coeffs=make_profile_coeffs(
