...
The solver path is intentionally cold-started from the homothetic initial
...
def build_solver_with_setup_timing(case: OperatorCase, solve_grid: Grid) -> tuple[Solver, float]:
...
def solve_once_with_cost_audit(
    case: OperatorCase, solve_grid: Grid
